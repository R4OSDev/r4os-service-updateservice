...
pub fn build(b: *std.Build) void {
    ...
    const host_r4os = b.createModule(.{
        .root_source_file = sdk_dep.path("r4os.zig"),
        .target = b.graph.host,
        .optimize = .Debug,
    });
    const r4std_abi = b.createModule(.{
        .root_source_file = b.path("../../Libraries/R4STD/Bindings/Zig/r4std_abi.zig"),
        .target = b.graph.host,
        .optimize = .Debug,
    });
    r4std_abi.addImport("r4os", host_r4os);
    const r4std = b.createModule(.{
        .root_source_file = b.path("../../Libraries/R4STD/Bindings/Zig/r4std.zig"),
        .target = b.graph.host,
        .optimize = .Debug,
    });
    ...
    const implementation = b.createModule(.{
        .root_source_file = b.path("../../Libraries/R4STD/Contract/Generated/implementation_abi.zig"),
        .target = b.graph.host,
        .optimize = .Debug,
    });
    implementation.addImport("r4os", host_r4os);
    const provider = b.createModule(.{
        .root_source_file = b.path("../../Libraries/R4STD/Source/main.zig"),
        .target = b.graph.host,
        .optimize = .Debug,
    });
    ...
    const r4std_test = b.createModule(.{
        .root_source_file = b.path("../../Libraries/R4STD/Tests/consumer_runtime.zig"),
        .target = b.graph.host,
        .optimize = .Debug,
    });
